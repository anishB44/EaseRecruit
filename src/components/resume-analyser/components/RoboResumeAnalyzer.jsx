...
const apiUrl = process.env.VITE_GOOGLE_API_URL;
      ...
      <div className="max-w-screen-xl w-full mx-auto p-4">
        <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg mb-6 md:mb-8 flex flex-col items-center">
          <div className="flex flex-col md:flex-row items-center justify-between w-full mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-primary flex items-center mb-4 md:mb-0">
              <FiFileText className="h-6 md:h-8 w-6 md:w-8 mr-2 md:mr-3 #691f74" />
              Upload Your Resume
            </h2>
          </div>
          <label
          ...
          <button
            className={`bg-primary hover:bg-primary-dark text-white py-2 mt-3 w-full px-4 md:py-3 md:px-6 rounded-md transition-transform transform hover:scale-105 flex items-center justify-center ${
        ...
        {response && (
          <div className="bg-white p-5 rounded-lg shadow-lg">
            <h2 className="text-3xl font-bold mb-6 text-primary flex items-center">
              <FiCheckCircle className="h-8 w-8 mr-3 text-primary" />
              Analysis Results
            </h2>
